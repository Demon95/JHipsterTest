...
import com.test.myapp.config.audit.AuditEventConverter;
import com.test.myapp.domain.PersistentAuditEvent;
...
import static com.test.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
